...
def readCommandLine():
    ...
    # Input/Output
    parser.add_argument("-c", "--train_dataset", required=False, type=str, default='../chatGPT/corpora/full.trainSelectedTopicsC.de', help="Training dataset for classification")
    parser.add_argument("-v", "--validation_dataset", type=str, default='../chatGPT/corpora/full.trainSelectedTopicsC.de', help="Validation set")
    ...
    parser.add_argument("-o", "--classification_model", required=False, type=str, default='./model/model.fr.8b56lre6.bin', help="Name for the model file")
    ...
    parser.add_argument("-b", "--batch_size", type=int, default=1, help="Number of documents in a batch. Default: 1")
    parser.add_argument("--sentence_batch_size", type=int, default=24, help="Number of sentences per document in a batch. Default: 24.")
    parser.add_argument("--eval_steps", type=int, default=1000, help="Number of batches prior to validation. Default: 100")

    parser.add_argument("-a", "--gradient_accumulation_steps", type=int, default=2, help="Number of steps before updating the gradients")
    parser.add_argument("--lr", type=float, default=5e-6, help="Learning rate for AdamW. Default: 2e-5.")
